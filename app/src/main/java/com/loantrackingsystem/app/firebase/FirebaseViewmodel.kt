...
class FirebaseViewmodel : ViewModel() {
    ...
    fun addLoan(loanDataModel: LoanDataModel,userId : String) = viewModelScope.launch(Dispatchers.IO) {

        try {
            usersCollection.document(userId).collection("loans").document(loanDataModel.loanID).set(loanDataModel).addOnSuccessListener {
    ...
    fun deleteLoan(loanDataModel: LoanDataModel) = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            usersCollection.document(loanDataModel.userid).collection("loans").document(loanDataModel.loanID).delete().addOnSuccessListener {
